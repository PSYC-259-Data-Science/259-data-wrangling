...
#match each data frame by a unique key (in this case, file name)
ds_joined <- left_join(header, ds, by = "file")
print(ds_joined)
#ds_joined has the right # of observations (240), and picked up all 9 variables from the header
...
#NA is saying "throw this out", we only want participant and block parts of the filename
